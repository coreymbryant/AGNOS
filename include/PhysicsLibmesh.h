 ...
 ***********************************************/
  ...
  /* { */
    ...
    /* /1* _meshRefinement->nele_target()               = 64; *1/ */  
 ...
 ***********************************************/
  ...
  /*   { */
      ...
      /* /1* _meshRefinement->flag_elements_by_error_tolerance (error_per_cell); *1/ */            
      /* /1* _meshRefinement->flag_elements_by_error_fraction (error_per_cell); *1/ */             
      ...
      /* /1* _meshRefinement->refine_elements(); *1/ */
