#ifndef QOI_DERIVATIVE_CATENARY_H
#define QOI_DERIVATIVE_CATENARY_H
...
namespace AGNOS
{
   ...
   ***********************************************/
  template<class T_S>
  class QoiDerivativeCatenary : public PhysicsQoiDerivative<T_S>
  {
    public:
      QoiDerivativeCatenary(
   ...
   ***********************************************/
  template<class T_S>
    QoiDerivativeCatenary<T_S>::QoiDerivativeCatenary( 
        libMesh::EquationSystems& es, 
        const std::string&        systemName
        )
   ...
   ***********************************************/
  template<class T_S>
    void QoiDerivativeCatenary<T_S>::qoi_derivative( 
...
#endif // QOI_DERIVATIVE_CATENARY_H
